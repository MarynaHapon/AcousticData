...
var media = [
  {
    file: 'assets/audio/aphex_twins_equation.mp3',
    slice: {start: 320000, end: 340000}
  },
  {
    file: 'assets/audio/ethos_final_hope.mp3',
    slice: {start: 50000, end: 170000}
  }
];


function init(btnMic, btnSong, select) {
  ...
  microphoneButton = document.getElementById( btnMic );
  songButton = document.getElementById( btnSong );
  songSelect = document.getElementById( select );
