...
// is called.
// ---
function StaticSpectrogram(filename, selector, options) {
  if (!options) {
    options = {};
  }
...
// better.
// ---
StaticSpectrogram.prototype.process = function(e) {
...
// ---
StaticSpectrogram.prototype.setupVisual = function() {
  ...
  this.button = d3.select('#vis_button')
...
// showProgress
// ---
StaticSpectrogram.prototype.showProgress = function() {
  if(this.isPlaying && this.isLoaded) {
...
// ---
StaticSpectrogram.prototype.switchButtonText = function() {
  this.button.text("Грати");
};

// ---
// Toggle playback
// ---
StaticSpectrogram.prototype.togglePlayback = function() {
  if (this.isPlaying) {
    this.source.stop(0);
...
// ---
// ---
StaticSpectrogram.prototype.draw = function() {
  var that = this;
...
// ---
// ---
StaticSpectrogram.prototype.getFrequencyValue = function(freq) {
...
// ---
// ---
StaticSpectrogram.prototype.getBinFrequency = function(index) {
  var nyquist = this.context.sampleRate/2;
  var freq = index / this.freqs.length * nyquist;
  return freq;
};

function buildStaticSpectrogram(audio, id, options) {
  if(this.context) {
    this.context.close();
  }
  // this.data = [];
  ...
  var staticSpectrogram = new StaticSpectrogram(audio, id, options);
  //staticSpectrogram.togglePlayback();
}

function deleteStaticSpectrogram() {
  //.selectAll("*").remove();
  ...
  // document.getElementById("vis").selectAll("*").remove();
